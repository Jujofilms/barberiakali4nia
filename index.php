...
<body class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
    ...
    <main class="main">
        <img src="img/img-principal.jpg" alt="fondo" class="img-fondo">
        <!-- Información -->
    ...
    <footer class="footer">
        ...
        <div class="horarios">
            <h1>Horarios</h1>
            <p>Lunes-Viernes <br> 8:00 a.m. - 8:00 p.m.</p>
            <p>Sábado-Domingo <br> 10:00 a.m. - 4:00 p.m.</p>
        </div>
    </footer>
