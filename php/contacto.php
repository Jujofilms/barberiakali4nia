...
<body class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
    ...
    <img src="../img/contacto.jpg" alt="fondo" class="img-fondo">
    <main class="main col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <!-- Información -->
        <h1 class="service">Contacto</h1>
        <section class="container">
            <div class="textPrincipal">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-envelope dorado" viewBox="0 0 16 16">
                    <path
                        d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z" />
                </svg>
                <p>Info@kali4nia.com</p>
            </div>
            <div class="textPrincipal">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-telephone verde" viewBox="0 0 16 16">
                    <path
    ...
    <footer class="footer">
        ...
        <div class="redesSociales">
            <h1>Síguenos</h1>
            <p>síguenos todas nuestras redes sociales como <br> Barbería Kali4nia</p>

            <!-- Whatsapp -->
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-whatsapp whtp" viewBox="0 0 16 16">
                <path
            ...
            <!-- Facebook -->
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-facebook face" viewBox="0 0 16 16">
                <path
            ...
            <!-- Instagram -->
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-instagram inst" viewBox="0 0 16 16">
                <path
        ...
        <div class="horarios">
            <h1>Horarios</h1>
            <p>Lunes-Viernes <br> 9:00 a.m. - 9:00 p.m.</p>
            <p>Sábado <br> 9:00 a.m. - 9:00 p.m.</p>
        </div>
...
<script>
    function toggleMenu() {
        var navbar = document.querySelector('.navbarPrincipal');
...
<script>
    function agendar() {
        let result = confirm("¿Desea agendar una cita?");

        if (result) {
            window.location.href = "../php/agendar.php";
        }
    }
